...
class CornersProblem(search.SearchProblem):
  # my "cornersProblem works and it expands 2036 nedes for
  # pacman.py -l mediumCorners -p SearchAgent -a fn=bfs,prob=CornersProblem
  # but autograder "thinks" that it is not an optimal solution
  ...
  def isGoal(self, state):
    ...
    #for k in range(0, 4):
      #if position == self.corners[k] and corners[0] and corners[1] and corners[2] and corners[3]:
        #return True
